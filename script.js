...
(() => {
  ...
  const works = [
    {
      id: 1,
      title: 'Объекты офисного и жилого назначения компании Талспецстрой',
      category: 'commercial',
      client: 'Организация',
      place: 'Нягань',
      year: '2023-2025',
      description: 'Объекты: два головных офисных здания, общежитие, столовая, база отдыха. На объектах выполнен полный комплекс электромонтажных работ от сборки ВРУ до установки электротехнических изделий общего назначения. Смонтированы системы автоматического управления приточно-вытяжной вентилляцией, выполнена настройка и пусконаладка.',
      image: 'assets/portfolio/01.jpg'
    },
    {
      id: 2,
      title: 'Подключение отапливаемых автобусных остановок',
      category: 'outdoor',
    ...
    },
    {
      ...
      place: 'Нягань',
      year: '2019',
      description: 'Объект: Няганьская ГРЭС, цех химводоочистки/водоподготовки. Выполнена модернизация узла реагентного хозяйства и КИПиА. Монтаж датчиков на ёмкостях серной кислоты и щёлочи (NaOH). Прокладка, маркировка и подключение кабельных линий в шкафы/щиты автоматики. Пусконаладка и интеграция сигналов/удалённого управления в АСУ ТП, через распределённые модули ввода‑вывода Siemens по промышленной сети.',
      image: 'assets/portfolio/06.jpg'
    },
    {
      id: 11,
    ...
    {
      id: 14,
      title: 'Жилой комплекс по улице Раимкулова',
      category: 'residential',
      client: 'Бизнес‑клиент',
      place: 'Нягань',
      year: '2015',
    ...
    },
    {
      ...
      place: 'Нягань',
      year: '2013-2014',
      description: 'Объекты: здание торгового центра. Выполнена сборка и монтаж ВРУ с подключением отходящих линий. Выполнено подключение щитов/автоматики, прокладка кабельных линий, как в скрытом исполнении, так и в кабель-каналах, расключение распаячных коробок, установка электротехнических изделий общего назначения.',
      image: 'assets/portfolio/06.jpg'
    },
    {
      id: 16,
      title: 'ЖК Эмдер в 6 микрорайоне',
      category: 'residential',
      client: 'Бизнес‑клиент',
      place: 'Нягань',
      year: '2013',
      description: 'Объект: многоквартирный жилой дом. Выполнен полный комплекс электромонтажных работ: сборка и монтаж ВРУ с подключением отходящих линий, установка и подключение этажных/групповых щитов, прокладка кабельных трасс, расключение распаечных коробок, монтаж и подключение электротехнических изделий общедомовых систем (освещение МОП и пр.). Дополнительно выполнены восстановительные работы и устранение замечаний после предыдущего подрядчика: корректировка трасс, доводка/восстановление недоложенных линий, исправление ошибок прокладки и подключений.',
      image: 'assets/portfolio/06.jpg'
    },
  ];
